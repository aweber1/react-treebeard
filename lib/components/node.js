...
var TreeNode = (function (_React$Component) {
    ...
    _createClass(TreeNode, [{
        ...
        value: function renderHeader(decorators, animations) {
            return _react2['default'].createElement(_header2['default'], _extends({}, this.passthrough(), {
        ...
        value: function renderChildren(decorators) {
            ...
            return _react2['default'].createElement(
                ...
                _reactUtils2['default'].children.map(this.props.node.children, function (child, index) {
                    return _react2['default'].createElement(TreeNode, _extends({}, _this.passthrough(), _this._eventBubbles(), {
                        key: child.id || index,
                        node: child,
        ...
        value: function renderLoading(decorators) {
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    'li',
                    null,
                    _react2['default'].createElement(decorators.Loading, _extends({}, this.passthrough(), { style: this.props.style.loading }))
                )
            );
        }
    }, {
...
exports['default'] = (0, _reactPassthrough2['default'])({ omit: ['children', 'form'] })(TreeNode);
