...
var NodeHeader = (function (_React$Component) {
    ...
    _createClass(NodeHeader, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(decorators.Container, _extends({}, this.passthrough(), {
                style: headerStyles,
...
exports['default'] = (0, _reactPassthrough2['default'])({ omit: ['children', 'form'] })(NodeHeader);
