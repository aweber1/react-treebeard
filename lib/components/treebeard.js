        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                data.map(function (node, index) {
                    return _react2['default'].createElement(_node2['default'], _extends({}, self.passthrough(), {
                        key: node.id || index,
                        node: node,
...
exports['default'] = (0, _reactPassthrough2['default'])({ omit: ['children', 'form', 'data'] })(TreeBeard);
